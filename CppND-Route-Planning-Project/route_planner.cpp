...
bool compareTwoNodeDis(RouteModel::Node *nodeA, RouteModel::Node *nodeB) {
    float totalA = nodeA->h_value + nodeA->g_value;
    float totalB = nodeB->h_value + nodeB->g_value;
    return totalA < totalB; 
}

RouteModel::Node *RoutePlanner::NextNode() {
  RouteModel::Node *next_node = nullptr;
  std::sort (open_list.begin(), open_list.end(), compareTwoNodeDis);
